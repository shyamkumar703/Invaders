...
/*
 */
open class MessageView: BaseView, SelfIdentifiable, AccessibleMessage {
...
extension MessageView {
     ...
     */
    func configureContent(body: FlexibleString) {
    ...
    /**
     ...
     - Parameter body: The message body text to use.
     */
    func configureContent(title: FlexibleString, body: FlexibleString) {
     ...
     */
    func configureContent(title: FlexibleString, body: FlexibleString, iconImage: UIImage) {
     ...
     */
    public func configureContent(title: FlexibleString, body: FlexibleString, iconText: FlexibleString) {
        configureContent(title: title, body: body)
