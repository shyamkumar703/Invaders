...
/**
 ...
 adopt the `SelfIdentifiable` protocol (as `MessageView` does) will have duplicates removed.
 */
    ...
    */
    public enum Event {
        ...
        public var id: String? {
            return (view as? SelfIdentifiable)?.id
        }
    }
    ...
    public struct Config {
        ...
        */
        ...
        /**
         Specified whether or not duplicate `SelfIdentifiable` messages are ignored.
         The default is `true`.
        */
    ...
    /**
     ...
     views, such as `MessageView`, that adopt the `SelfIdentifiable` protocol.
...
extension SwiftMessages {
    ...
    /**
     ...
     - Parameter id: The id of a message that adopts `SelfIdentifiable`.
...
extension SwiftMessages {
    ...
    fileprivate class func internalViewFromNib<T: UIView>(named name: String, bundle: Bundle? = nil, filesOwner: AnyObject = NSNull.init()) throws -> T {
        let arrayOfViews = TriumphCommon.bundle.loadNibNamed(name, owner: filesOwner, options: nil) ?? []
        #if swift(>=4.1)
